...
// ---------------------------------------------------------------------------
// AJUSTE QUADRÁTICO + CURVAS DE BOMBA — motor compartilhado em ./bombas.
// (Reexportado aqui para a API do módulo permanecer estável: a page importa daqui.)
// ---------------------------------------------------------------------------

export { ajustaQuadratica, curvaBomba, interseccao, amostraCurvas } from "./bombas";
export type { Quadratica } from "./bombas";
import { ajustaQuadratica, curvaBomba, interseccao, type Quadratica } from "./bombas";
